...
/**
 @description: layer 核心代码 原作者：贤心 参考地址：http://layer.layui.com/mobile/
 @date: 2018/3/9
 @author: Buggy(chenyuanhui@baie.com.cn)
 */
require('./layer.css');
const infoPhoto = "https://cdn.meiguipai.net/vutils/toastinfo.png";
const errorPhoto = "https://cdn.meiguipai.net/vutils/toasterror.png";
const successPhoto = "https://cdn.meiguipai.net/vutils/toastsuccess.png";
...
Layer.prototype.view = function () {
  ...
  let iconDom = '';
  if (config.showIcon) {
    switch (config.showIcon) {
      case "info":
        iconDom = `<img src=${infoPhoto} class="show-icon-size"/>`;
        break;
      case "error":
        iconDom = `<img src=${errorPhoto} class="show-icon-size"/>`;
        break;
      case "success":
        iconDom = `<img src=${successPhoto} class="show-icon-size"/>`;
        break;
      default:
        iconDom = "";
        break;
