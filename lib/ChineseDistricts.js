...
exports.getSubTexts = getSubTexts;
exports.getDetail = getDetail;
exports.getDetailByText = getDetailByText;
 ...
 * @returns {*}
 */
function getDetailByText(text, parentId) {
    if (parentId) {
        for (let id in ChineseDistricts[parentId]) {
...
function getTotalArea() {
    ...
    for (let provinceId in ChineseDistricts) {
        ...
        if (provinceId % 10000 === 0) {
            let tempName = getDetailText("86", provinceId).text,
                totalCity = [];
            for (let cityId in ChineseDistricts[provinceId]) {
                let tempCity = {},
                    tempArea = [],
                    tempName = getDetailText(provinceId, cityId).text;
